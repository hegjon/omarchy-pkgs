...
sha256sums=('c994bbe93257350a9fdbb599c3ed035b5da250f30c6d818932080a2536686ccb'
            'SKIP')
...
package_ldc() {
    ...
    backup=(
      ...
      'etc/ldc2.conf/51-target-wasm-base.conf'
      'etc/ldc2.conf/55-target-wasm-naked.conf'
